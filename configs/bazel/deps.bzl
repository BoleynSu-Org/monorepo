...
_DEPS_JSON = r"""
{
  ...
  "container_deps": [
    ...
    },
    {
      ...
      "tag": "latest",
      "digest": "sha256:c33b9fe0c4c10e2a94b62ba952e006c185dfece517c7e3303eff8473f2f523f3",
      "updated_at": "2024-02-21",
      "platforms": [
        "linux/amd64",
        "linux/arm64/v8",
...
DEPS = json.decode(_DEPS_JSON) if hash(_DEPS_JSON) == 972664176 else fail("deps.bzl is corrupted")

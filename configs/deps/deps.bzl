...
- name: io_k8s_kubernetes
  ...
  updated_at: '2022-07-17'
  version: v1.24.3
  build_file: '@boleynsu_org//third_party:kubernetes.BUILD'
...
""") if hash(_DEPS_YAML) != -1700262614 or hash(_DEPS_JSON) != 935526106 else None]

...
To manually update some deps,
    please edit _DPES_YAML and then run `REPIN=1 bazel run //cmd/infra/deps:update`.
"""
...
metadata:
  name: boleynsu_org
  pin_cmd: REPIN=1 bazel run //cmd/infra/deps:update
...
""") if hash(_DEPS_YAML) != -495961774 or hash(_DEPS_JSON) != 13736017 else None]

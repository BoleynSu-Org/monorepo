...
- name: rules_cc
  type: http_archive
  url: https://github.com/bazelbuild/rules_cc/archive/refs/tags/0.0.8.tar.gz
...
- name: rules_java
  ...
  url: https://github.com/bazelbuild/rules_java/archive/refs/tags/6.4.0.tar.gz
...
- name: io_grpc_grpc_java
  ...
  url: https://github.com/grpc/grpc-java/archive/refs/tags/v1.57.1.tar.gz
  updated_at: '2023-08-05'
  version: v1.57.1
  load_deps: |
...
- name: io_k8s_kubernetes
  type: http_archive
  url: https://github.com/kubernetes/kubernetes/archive/refs/tags/v1.27.4.tar.gz
  sha256: 1f5e7e33f2c698a8cd0b4f87c47cc4b511bebe38630f6a9614f549bd7f0be855
  strip_prefix: kubernetes-1.27.4
  updated_at: '2023-07-22'
  version: v1.27.4
...
- name: py3_debug_image_base
  ...
  tag: debug
  digest: sha256:a17f96f6bff4fe66ab278ffd18e984e2b369f42fed3f04ba09e636ab63e58ab2
  updated_at: '2023-06-04'
- name: py3_image_base
  version: latest
  version_regex: ^(latest)$
  ...
  repository: distroless/python3
  tag: latest
  digest: sha256:ae5236e5320dd11c4edc23b4d8c7d57536fdf2f9f98ffc2a34c89d5a259f0beb
  updated_at: '2023-06-04'
...
- name: io_quay_boleynsu_ci_runner
  version: '20230730.130340'
  registry: quay.io
  repository: boleynsu/ci-runner
  tag: '20230730.130340'
  digest: sha256:981640a520a15aa3c62c76b32e5be790a28f5f7c4b02b2fdc06a510e408dcf0b
...
- name: io_docker_library_mariadb
  ...
  tag: latest
  digest: sha256:c57215c3aabbdb96353ce8b89a7bd6be089f49a4d6bb37f199288a1bf0438a02
...
- name: io_quay_boleynsu_oj_c99runner
  ...
  tag: '20230730.130340'
  digest: sha256:f461afc97f3ef824c02994e7c20eae019efb82d433f28aafde222f008edeaf9e
  updated_at: '2023-07-30'
- name: io_quay_boleynsu_rbe_fedora
  ...
  tag: '20230730.130340'
  digest: sha256:a5e51c9425ec5a99a5d67cb5abbe9c53af8774037a49a2b2bba5b6bcd343a540
  updated_at: '2023-07-30'
...
""") if hash(_DEPS_YAML) != 204794956 or hash(_DEPS_JSON) != 1309944250 else None]

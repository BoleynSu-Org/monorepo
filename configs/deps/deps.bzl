...
To manually update some deps,
    please edit _DPES_YAML and then run `REPIN=1 bazel run //configs/deps:update`.
"""

# BEGIN deps.yaml
_DEPS_YAML = r"""
metadata:
  pin_cmd: REPIN=1 bazel run //configs/deps:update
...
""") if hash(_DEPS_YAML) != -1489854399 or hash(_DEPS_JSON) != -862638005 else None]

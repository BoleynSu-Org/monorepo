...
To manually update some deps,
    please edit _DPES_YAML and then run `bazel run //configs/deps:deps_bzl.genfile`.
"""
...
metadata:
  name: boleynsu_org
  pin_cmd: bazel run //configs/deps:deps_bzl.genfile
  include:
  - '@boleynsu_org//third_party/io_grpc_grpc_java_deps_bzl:deps.bzl'
...
- name: io_bazel_rules_k8s
  type: http_archive
  url: https://github.com/bazelbuild/rules_k8s/archive/64268c43a1cb7ae4689019fce472e1f1b6487f77.zip
  sha256: 904e8ba0acd7508fe95b8c8d20a3da8dcc0693f53eb19e76deb5939eaf55fb22
  strip_prefix: rules_k8s-64268c43a1cb7ae4689019fce472e1f1b6487f77
  updated_at: '2022-05-22'
  version: v0.6-64268c43a1cb7ae4689019fce472e1f1b6487f77
  # FIXME(https://github.com/bazelbuild/rules_k8s/issues/687):
  # container/go/pkg/compat/reader.go#ReadImage is changed in v0.20.0 and will break io_bazel_rules_k8s v0.6
...
- name: rules_python
  ...
  patches: ['@boleynsu_org//third_party:rules_python.patch']
...
- name: io_bazel_rules_go
  ...
  url: https://github.com/bazelbuild/rules_go/archive/refs/tags/v0.32.0.tar.gz
...
- name: java_debug_image_base
  ...
  tag: debug
  digest: sha256:fef55abcd0d950188b7369e85ef782c6d6b8842c291496612bcb455212a6c47f
  updated_at: '2022-05-19'
...
""") if hash(_DEPS_YAML) != -402085458 or hash(_DEPS_JSON) != -847658936 else None]
